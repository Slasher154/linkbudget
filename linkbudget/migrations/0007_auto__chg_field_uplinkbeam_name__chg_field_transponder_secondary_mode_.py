...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UplinkBeam.name'
        db.alter_column(u'linkbudget_uplinkbeam', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
        ...
        # Changing field 'DownlinkBeam.name'
        db.alter_column(u'linkbudget_downlinkbeam', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'UplinkBeam.name'
        db.alter_column(u'linkbudget_uplinkbeam', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
        ...
        # Changing field 'DownlinkBeam.name'
        db.alter_column(u'linkbudget_downlinkbeam', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
