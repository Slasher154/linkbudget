...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AntennaNoiseTemperature'
        db.create_table(u'linkbudget_antennanoisetemperature', (
        ...
        db.send_create_signal(u'linkbudget', ['AntennaNoiseTemperature'])


        # Changing field 'Transponder.primary_mode'
        db.alter_column(u'linkbudget_transponder', 'primary_mode', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Transponder.secondary_mode'
        db.alter_column(u'linkbudget_transponder', 'secondary_mode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):
        # Deleting model 'AntennaNoiseTemperature'
        db.delete_table(u'linkbudget_antennanoisetemperature')


        # Changing field 'Transponder.primary_mode'
        db.alter_column(u'linkbudget_transponder', 'primary_mode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Transponder.secondary_mode'
        db.alter_column(u'linkbudget_transponder', 'secondary_mode', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'linkbudget.antennanoisetemperature': {
            'Meta': {'object_name': 'AntennaNoiseTemperature'},
            'antenna': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linkbudget.Antenna']", 'null': 'True'}),
            'elevation_angle': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.FloatField', [], {})
        ...
        u'linkbudget.transponder': {
            ...
            'design_alc_deepin': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'primary_mode': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '10'}),
            'satellite': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linkbudget.Satellite']", 'null': 'True'}),
            'secondary_mode': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'})
        },
