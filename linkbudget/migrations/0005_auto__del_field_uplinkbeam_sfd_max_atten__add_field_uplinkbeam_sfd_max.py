...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transponder.primary_mode'
        db.add_column(u'linkbudget_transponder', 'primary_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'Transponder.secondary_mode'
        db.add_column(u'linkbudget_transponder', 'secondary_mode',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Transponder.primary_mode'
        db.delete_column(u'linkbudget_transponder', 'primary_mode')

        # Deleting field 'Transponder.secondary_mode'
        db.delete_column(u'linkbudget_transponder', 'secondary_mode')
