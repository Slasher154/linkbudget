...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.sfd_max_atten_alc'
        db.add_column(u'linkbudget_channel', 'sfd_max_atten_alc',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Channel.sfd_max_atten_fgm'
        db.add_column(u'linkbudget_channel', 'sfd_max_atten_fgm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'UplinkBeam.sfd_max_atten_fgm'
        db.delete_column(u'linkbudget_uplinkbeam', 'sfd_max_atten_fgm')

        # Deleting field 'UplinkBeam.sfd_max_atten_alc'
        db.delete_column(u'linkbudget_uplinkbeam', 'sfd_max_atten_alc')


    def backwards(self, orm):
        # Deleting field 'Channel.sfd_max_atten_alc'
        db.delete_column(u'linkbudget_channel', 'sfd_max_atten_alc')

        # Deleting field 'Channel.sfd_max_atten_fgm'
        db.delete_column(u'linkbudget_channel', 'sfd_max_atten_fgm')

        # Adding field 'UplinkBeam.sfd_max_atten_fgm'
        db.add_column(u'linkbudget_uplinkbeam', 'sfd_max_atten_fgm',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'UplinkBeam.sfd_max_atten_alc'
        db.add_column(u'linkbudget_uplinkbeam', 'sfd_max_atten_alc',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
