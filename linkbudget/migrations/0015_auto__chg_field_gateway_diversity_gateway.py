...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gateway.diversity_gateway'
        db.alter_column(u'linkbudget_gateway', 'diversity_gateway_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linkbudget.Gateway'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Gateway.diversity_gateway'
        raise RuntimeError("Cannot reverse this migration. 'Gateway.diversity_gateway' and its values cannot be restored.")
    ...
    models = {
        ...
        u'linkbudget.gateway': {
            ...
            'antenna': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linkbudget.Antenna']", 'null': 'True'}),
            'diversity_gateway': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linkbudget.Gateway']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
