...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Channel.center_frequency'
        db.delete_column(u'linkbudget_channel', 'center_frequency')

        # Adding field 'Channel.uplink_center_frequency'
        db.add_column(u'linkbudget_channel', 'uplink_center_frequency',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Channel.downlink_center_frequency'
        db.add_column(u'linkbudget_channel', 'downlink_center_frequency',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Channel.center_frequency'
        db.add_column(u'linkbudget_channel', 'center_frequency',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'Channel.uplink_center_frequency'
        db.delete_column(u'linkbudget_channel', 'uplink_center_frequency')

        # Deleting field 'Channel.downlink_center_frequency'
        db.delete_column(u'linkbudget_channel', 'downlink_center_frequency')
