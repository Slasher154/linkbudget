...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Antenna.vendor'
        db.add_column(u'linkbudget_antenna', 'vendor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linkbudget.AntennaVendor'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Antenna.vendor'
        db.delete_column(u'linkbudget_antenna', 'vendor_id')
