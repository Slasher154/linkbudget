...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transponder.design_alc_deepin'
        db.add_column(u'linkbudget_transponder', 'design_alc_deepin',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transponder.design_alc_deepin'
        db.delete_column(u'linkbudget_transponder', 'design_alc_deepin')
