...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transponder.Designed deep-in level at full-load for thistransponder (positive value). Input 0 if the transponder has FGM mode only'
        db.add_column(u'linkbudget_transponder', 'Designed deep-in level at full-load for thistransponder (positive value). Input 0 if the transponder has FGM mode only',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transponder.Designed deep-in level at full-load for thistransponder (positive value). Input 0 if the transponder has FGM mode only'
        db.delete_column(u'linkbudget_transponder', 'Designed deep-in level at full-load for thistransponder (positive value). Input 0 if the transponder has FGM mode only')
    ...
    models = {
        ...
        u'linkbudget.transponder': {
            'Designed deep-in level at full-load for thistransponder (positive value). Input 0 if the transponder has FGM mode only': ('django.db.models.fields.FloatField', [], {'default': '0'}),
