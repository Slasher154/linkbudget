...
#Include non-builtin functions for this project


# Custom json serializer. Serializes django queryset/objects into a simpler form than the default django serializer
# Source >> http://web.archive.org/web/20120414135953/http://www.traddicts.org/webdevelopment/flexible-and-simple-json-serialization-for-django
